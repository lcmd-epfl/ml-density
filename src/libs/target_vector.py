...
def do_work_target_pitc(mol_idx, paths, l_lambda_i, v_i, metric_i, mol_i, target_vec, ml_terms):
    ...
    Args:
        ...
        metric_i (np.ndarray): Jittered metric matrix of molecule i, from molecule_lambda_chol_knm().
        mol_i (pyscf.gto.Mole): Dummy mol matching molecule i's AO layout, from molecule_lambda_chol_knm().
    ...
    z_i = spl.solve_triangular(l_lambda_i, metric_inv_w_i, lower=True)  # L_i^-1 y_i
