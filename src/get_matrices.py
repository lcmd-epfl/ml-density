...
from libs.functions import nao_for_mol, get_training_sets, Basis
...
def main():
    ...
    if len(sys.argv)>1 and sys.argv[1][0].lower()=='b':
        ...
        get_b(basis.lmax, basis.nmax, totsize, ref_elements,
        ...
        get_a(basis.lmax, basis.nmax, totsize, ref_elements,
              nfrac, ntrains, train_configs,
